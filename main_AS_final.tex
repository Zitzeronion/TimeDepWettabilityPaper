...
\end{equation}
where $q_{\theta} = 2\pi/\lambda$, i.e.~the pattern evolves in time as a plane wave~\footnote{\textcolor{red}{A laboratory experiment for the here mentioned approach consists of a light switchable substrate with a thin film cast on it~\cite{becker2003complex, IchimuraEtAl_Science2000}. 
...
\begin{figure}
    ...
    \caption{Stationary film thickness field ($t>4t_0$) showing the formation of droplets. The color map indicates the contact angle pattern 
...
\begin{figure}
    \centering
    \includegraphics[width=0.45\textwidth]{Rupture_times_Gamma_theta_20.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.45\textwidth]{Static_new_theta20t0.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.45\textwidth]{lam_2_inset_theta20.pdf}
...
\begin{figure}
    ...
    \includegraphics[width=0.45\textwidth]{lig_lifetime_Gamma_theta20.pdf}
